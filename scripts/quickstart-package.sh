...
APP_DIR="edge-sample-scaler-cpp"
APP_NAME="Predix Edge Sample Scaler CPP - package"
...
if [[ -e 'predix-scripts' ]]; then
  ...
  echo "Please run quickstart-edge-sample-scaler-app.sh first before running this script."
  exit 1
fi
